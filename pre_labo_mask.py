...
def main():
    ...
    with open('masked_concepts.json', 'r') as fp:
    ...
    np.save(os.path.join('save_labo', f"attribute_activations_train_mask.npy"), attribute_activations_train)
    np.save(os.path.join('save_labo', f"attribute_activations_valid_mask.npy"), attribute_activations_valid)
