...
def main():
    ...
    tr_att_activations = torch.Tensor(np.load('save_des' + "/attribute_activations_train_90.npy"))
    t_att_activations = torch.Tensor(np.load('save_des' + "/attribute_activations_valid_90.npy"))
