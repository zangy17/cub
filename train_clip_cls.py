...
data, _, _ = load_data(data_root='../vlm_concept/vlm_concept/data/CUB_200_2011', split="all")
class_id_dict = {}
...
for row_id in range(len(data)):
    ...
    image_path = os.path.join("../vlm_concept/vlm_concept/data/CUB_200_2011", "CUB_200_2011", "images", image_name)
...
texts = ['a photo of a '+c+', a type of bird.' for c in class_names]
...
for epoch in range(100):
    ...
    if epoch %10==1:
        torch.save(model.state_dict(), 'checkpoint/cub_des_cls' + str(epoch) + '.pt')