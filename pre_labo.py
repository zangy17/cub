...
def main():
    ...
    np.save(os.path.join('save_labo', f"attribute_activations_train.npy"), attribute_activations_train)
    np.save(os.path.join('save_labo', f"attribute_activations_valid.npy"), attribute_activations_valid)
