...
PATH_TO_PROMPTS = "full_cub_of.json"
...
for row_id in tqdm(range(len(data))):
    image_id, image_name, is_training, class_id = data.iloc[row_id][
        ["image_id", "filepath", "is_training_image", "class_id"]]
...
with open('pred_labels_of.json','w') as fw:
