...
with open('concepts_400.json','w') as fw:
    json.dump(new_concepts,fw)
np.save('class_label_labo_400.npy',new_class_label)
...
with open('labo_400.json','w') as fw:
    json.dump(cub_fff,fw)
with open('full_labo_400.json','w') as fw:
