...
def main():
    ...
    np.save(os.path.join('save_des', f"attribute_activations_train_90.npy"), attribute_activations_train)
    np.save(os.path.join('save_des', f"attribute_activations_valid_90.npy"), attribute_activations_valid)
