...
def main():
    ...
    with open('concepts_400.json', 'r') as fp:
    ...
    np.save(os.path.join('save_labo', f"attribute_activations_train_400_r.npy"), attribute_activations_train)
    np.save(os.path.join('save_labo', f"attribute_activations_valid_400_r.npy"), attribute_activations_valid)
