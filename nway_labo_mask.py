...
def main():
    ...
    cls_truth = np.load('class_label_labo_mask.npy')


    # primitive concept activations
    tr_att_activations = torch.Tensor(np.load('save_labo' + "/attribute_activations_train_mask.npy"))
    t_att_activations = torch.Tensor(np.load('save_labo' + "/attribute_activations_valid_mask.npy"))
