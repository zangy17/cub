...
def main():
    ...
    np.save(os.path.join('save_des', f"attribute_activations_train_oo.npy"), attribute_activations_train)
    np.save(os.path.join('save_des', f"attribute_activations_valid_oo.npy"), attribute_activations_valid)
