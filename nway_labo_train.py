...
def main():
    ...
    tr_att_activations = torch.Tensor(np.load('save_labo_train' + "/attribute_activations_train.npy"))
    t_att_activations = torch.Tensor(np.load('save_labo_train' + "/attribute_activations_valid.npy"))
