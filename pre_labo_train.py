...
def main():
    ...
    model.load_state_dict(torch.load('checkpoint/cub_labo_random99.pt', map_location='cuda:0'))
    ...
    with open('concepts_random.json', 'r') as fp:
    ...
    np.save(os.path.join('save_labo_train', f"attribute_activations_train.npy"), attribute_activations_train)
    np.save(os.path.join('save_labo_train', f"attribute_activations_valid.npy"), attribute_activations_valid)
